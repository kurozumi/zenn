---
title: "EC-CUBEエンジニアがLaravel案件に参画するために覚えること【2〜3週間で即戦力になる変換表】"
emoji: "🔄"
type: "tech"
topics: ["laravel", "symfony", "eccube", "php"]
published: true
---
...
:::message
この記事はEC-CUBEエンジニア（Symfonyベースの知識あり）を対象としています。
[Claude Code](https://claude.ai/claude-code) を使って書かれています。内容に誤りがある場合はコメントでお知らせください。
:::
