...
### 方法1: Web API 個人用アクセストークン生成プラグイン（簡単）

**[Web API 個人用アクセストークン生成プラグイン](https://www.ec-cube.net/products/detail.php?product_id=3467)** を使うと、OAuthクライアントの登録手順を省略して個人用のアクセストークンをかんたんに発行できます。開発・検証環境や個人利用での導入に便利です。
