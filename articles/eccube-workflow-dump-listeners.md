---
title: "EC-CUBEの受注ステータス遷移図、コードを読まずに1コマンドで確認できる【workflow:dump】"
emoji: "🗺️"
type: "tech"
topics: ["eccube", "eccube4", "symfony", "php", "workflow"]
published: true
---
...
:::message alert
この機能は **Symfony 8.1 向けのオープン中のPR（#63809）** です。EC-CUBE 4.3（Symfony ^6.4）では現時点で使えません。将来のアップグレード後に利用可能になる予定です。
:::
