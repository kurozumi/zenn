...
⚠️ PR #47210 は **Symfony 8.1 向けのオープン中のPR**（マイルストーン 2026-05-31）です。EC-CUBE 4.3（Symfony ^6.4）では現時点で使えません。2022年から議論が続いており、マイルストーンが繰り返し先送りされてきた経緯があります。EC-CUBE 本体の Symfony アップグレード（PR #6686 で 7.4 への移行が進行中）後、さらに将来のバージョンで利用可能になる予定です。
